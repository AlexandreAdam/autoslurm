...
- `07_acp_actions.md` plus `acp_action.json` explain `list_experiments` (enumerate bundle files), so you can detect the latest bundle of a given name before submitting or monitoring.
